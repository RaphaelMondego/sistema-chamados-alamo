  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "status-open": "border-transparent bg-status-open text-white",
        "status-progress": "border-transparent bg-status-progress text-white",
        "status-resolved": "border-transparent bg-status-resolved text-white",
        "status-closed": "border-transparent bg-status-closed text-white",
      },
    },
    defaultVariants: {
      variant: "default",
